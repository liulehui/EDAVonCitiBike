...
* Whether weather and season have impacts on Citi Bike Usage frequency 
...
The unit of trip duration in the dataframe is second which we think is not quite suitable for analyzing. Thus, we transform the unit into minutes by dividing 60. **Since the data is bike.**
```{r}
