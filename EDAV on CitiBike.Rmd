...
<<<<<<< HEAD
  ...
  ggtitle("Number of trips per day under severe and unsevere weather condition")
=======
...
>>>>>>> 166f5a6810b2bd5347003bf44dd6119ff1c1f9bf
```
...
<<<<<<< HEAD
timeslot <- ggplot(data=df_timeslot,mapping=aes(as.factor(hour))) +geom_bar(fill='#fb6a4a')+ggtitle('Rush hour in trip data group by usertype')
=======
...
```{r}
<<<<<<< HEAD
ggplot(data=df,mapping=aes(minute)) + geom_histogram(fill='#fb6a4a',color='black')+ggtitle('Distribution of time duration') +xlab('minutes over one trip') + ylab('Frequency of trips')+ theme_grey(16)+scale_y_continuous(breaks = seq(0,500000,100000),labels = c("0","100K","200K","300K","400K","500K"))
=======
...
ggplot(df_weather, aes(x=Severe))+
<<<<<<< HEAD
  geom_bar(colour="white", fill="#fb6a4a")+ggtitle("Number of trips per day for severe and unsevere weather condition") +theme_grey(16) + ylab('Frequency') + scale_y_continuous(breaks = seq(0,1000000,250000),labels = c("0","250K","500K","750K","1M"))
=======
